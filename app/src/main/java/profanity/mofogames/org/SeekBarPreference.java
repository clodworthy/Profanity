...
public final class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    //private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/com.mnm.seekbarpreference";
	 private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/org.mofogames.profanity";
    ...
    Log.d(TAG, Integer.toString(mMinValue));
    Log.d(TAG, Integer.toString(mMaxValue));
    Log.d(TAG, Integer.toString(mDefaultValue));
...
//    /**
//     * Methods for implementing Observer-Observable design Pattern
//     */
//    private boolean registerObserver(Observer o){
//    	return observable.registerObserver(o);
//    }
//    
//    private boolean unregisterObserver(Observer o){
//    	return observable.unregisterObserver(o);
//    }
//    
//    private boolean unregisterAll(){
//    	return observable.unregisterAll();
//    }
//    
//    private boolean isRegistered(Observer o){
//    	return observable.isRegistered(o);
//    }
//    
//    
